# TODO: Run coverage collection concurrently in the future.
# Adjust worker counts according to the available CPU cores and GPUs.
import argparse
import json
import os
import re
...
def coverage_report(
    ...
    for py_file in tqdm(sampled_pyfiles):
        ...
        try:  # avoid locking the process on slow test cases
