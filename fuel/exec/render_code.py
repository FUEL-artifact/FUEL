...
class CodeParser:
    def __init__(self, lib_name: str = "pytorch") -> None:
        ...
        if lib_name == "pytorch":
            ...
            self.imports = (
                ...
                "torch.set_grad_enabled(False)\n"  # Disable gradients; support gradient operators in the future
    ...
    def split_func_tensor(self, code):
        ...
        if class_init_code != "":
            ...
            class_init_code += f"\nmodel = {class_name}({', '.join(class_init_required_args)})\n"  # TODO: consider whether `.eval()` should be added here
        class_code += "\n" + class_init_code
...
def get_rendered_code(lib: str, code: str) -> str:
    ...
    # Preprocess common formatting issues in generated code.
