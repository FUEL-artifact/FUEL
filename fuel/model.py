...
class RemoteModel(Model):
    ...
    def get_outputs(self, role, prompt, code_gen):
        ...
        # FIXME: Different LLM API service providers have different mechanisms to force code generation.
...
class AlsLocalModel(LocalModel):  # TODO: add the analyze function for als model
    def __init__(self, config, **kwargs):
        super().__init__(config, **kwargs)
