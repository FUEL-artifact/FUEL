# TODO@: Evaluation process is so slow which makes me annoying. Can we execute concurrently in the future?
...
def coverage_report(
    ...
    for py_file in tqdm(sampled_pyfiles):
        ...
        try:  # @: I add this exception processing to avoid the timeout (bc some test case are too slow to make the process lock)
